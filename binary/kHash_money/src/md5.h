...
static struct hash_obj MD5_HASHER = {
	//hopefully .ops.decode is silently set to NULL - check
	//may have to explicitly set it to NULL, but I think stuff in the .bss is usually set to 0 initially
	.ops = {
		.encode = md5_encode,
		.info = md5_info,
	},
