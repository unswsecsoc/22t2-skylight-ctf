...
enum opt_code
{
  ...
  OPT_mbranch_cost_ = 1043,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1044,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1045,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1046,                /* -mcode-readable= */
  OPT_mdebug = 1047,                         /* -mdebug */
  OPT_mdebugd = 1048,                        /* -mdebugd */
  OPT_mdivide_breaks = 1049,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1050,                  /* -mdivide-traps */
  OPT_mdmx = 1051,                           /* -mdmx */
  OPT_mdouble_float = 1052,                  /* -mdouble-float */
  OPT_mdsp = 1053,                           /* -mdsp */
  OPT_mdspr2 = 1054,                         /* -mdspr2 */
  OPT_meb = 1055,                            /* -meb */
  OPT_mel = 1056,                            /* -mel */
  OPT_membedded_data = 1057,                 /* -membedded-data */
  OPT_mexplicit_relocs = 1058,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1059,                  /* -mextern-sdata */
  OPT_mfix_24k = 1060,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1061,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1062,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1063,                     /* -mfix-r4400 */
  OPT_mfix_sb1 = 1064,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1065,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1066,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1067,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1068,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1069,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1070,                 /* -mfp-exceptions */
  OPT_mfp32 = 1071,                          /* -mfp32 */
  OPT_mfp64 = 1072,                          /* -mfp64 */
  OPT_mfused_madd = 1073,                    /* -mfused-madd */
  OPT_mgp32 = 1074,                          /* -mgp32 */
  OPT_mgp64 = 1075,                          /* -mgp64 */
  OPT_mgpopt = 1076,                         /* -mgpopt */
  OPT_mhard_float = 1077,                    /* -mhard-float */
  OPT_minterlink_mips16 = 1078,              /* -minterlink-mips16 */
  OPT_mips = 1079,                           /* -mips */
  OPT_mips16 = 1080,                         /* -mips16 */
  OPT_mips3d = 1081,                         /* -mips3d */
  OPT_mllsc = 1082,                          /* -mllsc */
  OPT_mlocal_sdata = 1083,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1084,                    /* -mlong-calls */
  OPT_mlong32 = 1085,                        /* -mlong32 */
  OPT_mlong64 = 1086,                        /* -mlong64 */
  OPT_mmad = 1087,                           /* -mmad */
  OPT_mmcount_ra_address = 1088,             /* -mmcount-ra-address */
  OPT_mmcu = 1089,                           /* -mmcu */
  OPT_mmemcpy = 1090,                        /* -mmemcpy */
  OPT_mmt = 1091,                            /* -mmt */
  OPT_mno_float = 1092,                      /* -mno-float */
  OPT_mno_flush_func = 1093,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1094,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1095,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1096,                     /* -mno-mips3d */
  OPT_mpaired_single = 1097,                 /* -mpaired-single */
  OPT_mplt = 1098,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1099,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1100,               /* -mrelax-pic-calls */
  OPT_mshared = 1101,                        /* -mshared */
  OPT_msingle_float = 1102,                  /* -msingle-float */
  OPT_msmartmips = 1103,                     /* -msmartmips */
  OPT_msoft_float = 1104,                    /* -msoft-float */
  OPT_msplit_addresses = 1105,               /* -msplit-addresses */
  OPT_msym32 = 1106,                         /* -msym32 */
  OPT_msynci = 1107,                         /* -msynci */
  OPT_mtune_ = 1108,                         /* -mtune= */
  OPT_muninit_const_in_rodata = 1109,        /* -muninit-const-in-rodata */
  OPT_mvr4130_align = 1110,                  /* -mvr4130-align */
  OPT_mxgot = 1111,                          /* -mxgot */
  OPT_n = 1112,                              /* -n */
  OPT_no_canonical_prefixes = 1113,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1114,              /* -no-integrated-cpp */
  OPT_noasmopt = 1115,                       /* -noasmopt */
  OPT_nocpp = 1116,                          /* -nocpp */
  OPT_nodefaultlibs = 1117,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1118,                   /* -nostartfiles */
  OPT_nostdinc = 1119,                       /* -nostdinc */
  OPT_nostdinc__ = 1120,                     /* -nostdinc++ */
  OPT_nostdlib = 1121,                       /* -nostdlib */
  OPT_o = 1122,                              /* -o */
  OPT_p = 1123,                              /* -p */
  OPT_pass_exit_codes = 1124,                /* -pass-exit-codes */
  /* OPT_pedantic = 1125, */                 /* -pedantic */
  OPT_pedantic_errors = 1126,                /* -pedantic-errors */
  OPT_pg = 1127,                             /* -pg */
  OPT_pie = 1128,                            /* -pie */
  OPT_pipe = 1129,                           /* -pipe */
  ...
  OPT_r = 1142,                              /* -r */
  OPT_remap = 1143,                          /* -remap */
  OPT_s = 1144,                              /* -s */
  OPT_s_bc_abi = 1145,                       /* -s-bc-abi */
  OPT_save_temps = 1146,                     /* -save-temps */
  OPT_save_temps_ = 1147,                    /* -save-temps= */
  OPT_shared = 1148,                         /* -shared */
  OPT_shared_libgcc = 1149,                  /* -shared-libgcc */
  /* OPT_specs = 1150, */                    /* -specs */
  OPT_specs_ = 1151,                         /* -specs= */
  OPT_static = 1152,                         /* -static */
  OPT_static_libasan = 1153,                 /* -static-libasan */
  OPT_static_libgcc = 1154,                  /* -static-libgcc */
  OPT_static_libgcj = 1155,                  /* -static-libgcj */
  OPT_static_libgfortran = 1156,             /* -static-libgfortran */
  OPT_static_libgo = 1157,                   /* -static-libgo */
  ...
  OPT_std_c__1y = 1163,                      /* -std=c++1y */
  OPT_std_c__98 = 1164,                      /* -std=c++98 */
  OPT_std_c11 = 1165,                        /* -std=c11 */
  /* OPT_std_c1x = 1166, */                  /* -std=c1x */
  /* OPT_std_c89 = 1167, */                  /* -std=c89 */
  OPT_std_c90 = 1168,                        /* -std=c90 */
  OPT_std_c99 = 1169,                        /* -std=c99 */
  /* OPT_std_c9x = 1170, */                  /* -std=c9x */
  OPT_std_f2003 = 1171,                      /* -std=f2003 */
  OPT_std_f2008 = 1172,                      /* -std=f2008 */
  OPT_std_f2008ts = 1173,                    /* -std=f2008ts */
  OPT_std_f95 = 1174,                        /* -std=f95 */
  OPT_std_gnu = 1175,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1176, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1177, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1178,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1179,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1180,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1181,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1182, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1183, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1184,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1185,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1186, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1187, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1188,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1189, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1190, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1191, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1192,                     /* -std=legacy */
  OPT_symbolic = 1193,                       /* -symbolic */
  OPT_t = 1194,                              /* -t */
  OPT_time = 1195,                           /* -time */
  OPT_time_ = 1196,                          /* -time= */
  OPT_traditional = 1197,                    /* -traditional */
  OPT_traditional_cpp = 1198,                /* -traditional-cpp */
  OPT_trigraphs = 1199,                      /* -trigraphs */
  OPT_u = 1200,                              /* -u */
  OPT_undef = 1201,                          /* -undef */
  OPT_v = 1202,                              /* -v */
  OPT_version = 1203,                        /* -version */
  OPT_w = 1204,                              /* -w */
  OPT_wrapper = 1205,                        /* -wrapper */
  OPT_x = 1206,                              /* -x */
  OPT_z = 1207,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
